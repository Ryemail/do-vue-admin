	...
	<div>
		...
		<div class="module">
			...
			<div class="module-content">
				<div>
					<d-upload :action="action" accept="image" v-model="image.value1">
						<div slot="tip" style="font-size: 12px">只能上传.png、.jpg格式</div>
					</d-upload>
					<div>{{ image.value1 }}</div>
				</div>

				<div>
					<d-upload :action="action" accept="image" v-model="image.value2">
						<el-button icon="el-icon-plus" slot="image"> 自定义图片上传样式 </el-button>
					</d-upload>
